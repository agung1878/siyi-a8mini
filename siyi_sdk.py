...
class SIYISDK:
    ...
    def __init__(self, server_ip="192.168.2.119", port=2000, debug=True):
        """
        Params
        --
    ...
    def connect(self, maxWaitTime=3.0, maxRetries=2):
        """
    ...
    def requestGimbalAttitude(self):
        ...
        print(f"ini message yang dikriim {msg}")
        if not self.sendMsg(msg):
            return False
        return True
